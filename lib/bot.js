        ...
        if (messageText)
        {
            ...
            else 
            {
                ...
                if (fireworkex.test(messageText)) {
                    ...
                    var fireworksS = "Fireworks? I remember… explosions! Canons shooting from every which way. We had just left china with the rarest of materials… gun powder. The best on the globe. We traveled 3 continents for this stuff but we were about to lose it all to these terrible Canadians. You may think they are friendly now but back then they were like a moose after you just interrupted their mating ritual. They started boarding us, all but 3 of us, including Big Hat Matt were captured! They started searching floor by floor so we scurried down to the bottom level. It seemed like all was lost. Suddenly a canon flew into our ship! A great big hole with water gaping in. Big Hat Matt started to plug it but I stopped him. I grabbed a spare barrel of powder, swam through the hole right to the bottom of their ship. I grabbed my knife and my trusty pocket watch. I opened the barrel and struck my watch. A sound louder than the Kraken erupted just before everything went black… and.. that’s all I remember… that and painful hunger.";
                    return point + fireworksS;
                }
                ...
                if (freedomex.teset(messageText)) {
                    if (freedom == 0) {
                        Functions.easteregg(messageUId);
                        freedom = 1;
                    }
