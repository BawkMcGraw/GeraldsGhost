...
class Functions {
    ...
    static easteregg(messageid) {
         ...
         * need a story arch for gerald and 4th of july         -20%-
         * need a list of expressions to look for               -20%-
