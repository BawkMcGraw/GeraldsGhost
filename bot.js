...
/** MASTER DEV PLAN
 * Seperate values for different groups     -DEPRECATED-
...
/**    static saveid() {
    ...
    */
    static timeout() {
        ...
        var timie = timer.toString();
        var cut = timie.slice(4);
        var timen = parseInt(cut, 10);
        var time = timen
        if (t === undefined) {
    ...
    static dailyStory() {
        ...
        var daily = [
            ...
            'Day 8 in the ghost house. One of the ghosts who used to be a copywright lawyer found my diary and told me to, *airquotes* "Cut that shit out" *airquotes*. So after about an hour of scissors, tape, and architecture magazines, I have a "refurbished" diary. To the future with copywright free experiences!'
        ]
        var date = new Date();
    ...
    static easteregg(messageid) {
         ...
         * need a reward for winner                             -COMPLETE-
         * impliment a way to send hints to sepcific players    -DEPRECATED-
         * need hints for future expressions                    -COMPLETE-
         * send long stories in multiple parts                  -COMPLETE-
         * remove 4th of July triggers
         */
    }
}
            ...
            else 
            {
                ...
                */
                ...
                if (botRegex.test(messageText) || botRegex2.test(messageText) || botRegex3.test(messageText))
                {
                    ...
                    if (helpex.test(messageText)) {
                        console.log('help dispensed');
                        return 'What can I help you with??? I can tell tales, accept sacrifices, or tell you how many of either yee have done, just ask how many.'
                    }
                    if (i == 0 || i == undefined)
                    {
                        console.log('i = 0');
